...
PID: 10149
Date: 2019-10-24 19:26:07+0900
Executable File Path: /opt/usr/apps/org.example.sensorbasicui/bin/sensorbasicui
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 10149, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000027a5
r2   = 0x00000006, r3   = 0x000027a5
r4   = 0x00000006, r5   = 0x000f5528
r6   = 0x404d4bec, r7   = 0x0000010c
r8   = 0x42f961a0, r9   = 0x00000002
r10  = 0x0000007a, fp   = 0xbeeaec78
ip   = 0x42f96660, sp   = 0xbeeae540
...
Threads: 7
PID = 10149 TID = 10149
10149 10159 10160 10161 10163 10174 10175 
...
40047000 4004a000 rw-p [stack:10175]
...
4349a000 43c99000 rw-p [stack:10159]
43c9a000 44499000 rw-p [stack:10160]
444af000 44cae000 rw-p [stack:10161]
44caf000 454ae000 rw-p [stack:10163]
...
45697000 45e96000 rw-p [stack:10174]
45e96000 45e9b000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
bee8f000 beeb0000 rw-p [stack]
End of Maps Information

Callstack Information (PID:10149)
Call Stack Count: 1
...
:07.296+0900 I/MESSAGE_PORT(  506): MessagePortService.cpp: CheckRemotePort(213) > Check a remote message port: [com.samsung.w-music-player.music-control-service:music-control-service-request-message-port]
10-24 19:26:07.296+0900 E/MESSAGE_PORT(  506): MessagePortService.cpp: CheckRemotePort(235) > _MessagePortService::CheckRemotePort() Failed: MESSAGEPORT_ERROR_MESSAGEPORT_NOT_FOUND
10-24 19:26:07.296+0900 I/MESSAGE_PORT(  506): MessagePortIpcServer.cpp: Send(847) > _MessagePortIpcServer::Stop
10-24 19:26:07.311+0900 E/MESSAGE_PORT(  776): MessagePortProxy.cpp: CheckRemotePort(379) > The remote message port (music-control-service-request-message-port) is not found.
10-24 19:26:07.311+0900 W/W_HOME  (  776): clock_shortcut.c: _request_with_message_port(118) > remote port does not exist
10-24 19:26:07.311+0900 W/AUL     (  776): launch.c: app_request_to_launchpad(268) > request cmd(0) to(com.samsung.w-music-player.music-control-service)
10-24 19:26:07.311+0900 W/AUL_AMD (  540): amd_request.c: __request_handler(645) > __request_handler: 0
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_request.c: __request_handler(669) > no appinfo
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_appinfo.c: appinfo_get_value(1150) > appinfo get value: Invalid argument, 9
10-24 19:26:07.316+0900 E/PKGMGR_INFO(  540): pkgmgrinfo_pkginfo.c: pkgmgrinfo_updateinfo_check_update(2505) > (pkgid == NULL) pkgid is NULL
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_appinfo.c: appinfo_get_value(1150) > appinfo get value: Invalid argument, 28
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_appinfo.c: appinfo_get_value(1150) > appinfo get value: Invalid argument, 27
10-24 19:26:07.316+0900 W/AUL_AMD (  540): amd_launch.c: _start_app(1713) > caller pid : 776
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_launch.c: _start_app(1726) > no appinfo
10-24 19:26:07.316+0900 E/AUL_AMD (  540): amd_launch.c: __real_send(835) > send fail to client
10-24 19:26:07.321+0900 W/AUL     (  776): launch.c: app_request_to_launchpad(282) > request cmd(0) result(-13)
10-24 19:26:07.321+0900 E/CAPI_APPFW_APP_CONTROL(  776): app_control.c: app_control_error(138) > [app_control_send_launch_request] APP_NOT_FOUND(0xfef00021)
10-24 19:26:07.321+0900 W/W_HOME  (  776): clock_shortcut.c: _mp_messageport_register(150) > err = fef00021
10-24 19:26:07.326+0900 W/AUL_AMD (  540): amd_key.c: _key_ungrab(254) > fail(-1) to ungrab key(XF86Stop)
10-24 19:26:07.326+0900 W/AUL_AMD (  540): amd_launch.c: __e17_status_handler(2295) > back key ungrab error
10-24 19:26:07.356+0900 I/APP_CORE(10149): appcore-efl.c: __do_app(429) > [APP 10149] Event: RESUME State: RUNNING
10-24 19:26:07.366+0900 I/sensorbasicui(10149): Calling the sensor update callback function:
10-24 19:26:07.371+0900 I/sensorbasicui(10149): CREATED/OPENED TABLE DataTable
10-24 19:26:07.376+0900 W/AUL_AMD (  540): amd_request.c: __request_handler(645) > __request_handler: 12
10-24 19:26:07.446+0900 W/wnotib  (  776): w-notification-board-broker-main.c: _wnb_ecore_x_event_visibility_changed_cb(420) > fully_obscured: 1
10-24 19:26:07.606+0900 E/AUL     (  540): app_signal.c: __app_dbus_signal_filter(94) > reject by security issue - no interface
10-24 19:26:07.816+0900 E/WMS     (  537): wms_event_handler.c: _wms_event_handler_cb_nomove_detector(23255) > _wms_event_handler_cb_nomove_detector is called
10-24 19:26:07.831+0900 I/APP_CORE(  776): appcore-efl.c: __do_app(429) > [APP 776] Event: MEM_FLUSH State: PAUSED
10-24 19:26:07.996+0900 W/AUL     (10178): daemon-manager-release-agent.c: main(12) > release agent : [2:/org.example.sensorbasicui]
10-24 19:26:08.001+0900 W/AUL_AMD (  540): amd_request.c: __request_handler(645) > __request_handler: 23
10-24 19:26:08.001+0900 W/AUL_AMD (  540): amd_request.c: __send_result_to_client(83) > __send_result_to_client, pid: 0
10-24 19:26:08.001+0900 W/AUL_AMD (  540): amd_request.c: __request_handler(949) > pkg_status: installed, dead pid: 10149
10-24 19:26:08.001+0900 W/AUL_AMD (  540): amd_request.c: __send_app_termination_signal(510) > send dead signal done
10-24 19:26:08.051+0900 W/AUL_AMD (  540): amd_key.c: _key_ungrab(254) > fail(-1) to ungrab key(XF86Stop)
10-24 19:26:08.051+0900 W/AUL_AMD (  540): amd_launch.c: __e17_status_handler(2295) > back key ungrab error
10-24 19:26:08.071+0900 I/MALI    (  776): egl_platform_x11_tizen.c: tizen_update_native_surface_private(194) > [EGL-X11] surface->[0x442abba8] swap changed from sync to async
10-24 19:26:08.076+0900 I/AUL_AMD (  540): amd_main.c: __app_dead_handler(263) > __app_dead_handler, pid: 10149
10-24 19:26:08.451+0900 W/PROCESSMGR(  419): e_mod_processmgr.c: _e_mod_processmgr_send_update_watch_action(639) > [PROCESSMGR] =====================> send UpdateClock
10-24 19:26:08.451+0900 W/WATCH_CORE(  818): appcore-watch.c: __signal_process_manager_handler(1190) > process_manager_signal
10-24 19:26:08.451+0900 I/WATCH_CORE(  818): appcore-watch.c: __signal_process_manager_handler(1206) > Call the time_tick_cb
10-24 19:26:08.451+0900 I/CAPI_WATCH_APPLICATION(  818): watch_app_main.c: _watch_core_time_tick(306) > _watch_core_time_tick
10-24 19:26:08.451+0900 E/watchface-loader(  818): watchface-loader.cpp: OnAppTimeTick(673) > 
10-24 19:26:08.451+0900 I/watchface-loader(  818): watchface-loader.cpp: OnAppTimeTick(684) > set force update!!
10-24 19:26:08.476+0900 W/W_HOME  (  776): event_manager.c: _ecore_x_message_cb(414) > state: 1 -> 0
10-24 19:26:08.476+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:4, app_state:2 win_state:0(0) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.476+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:2, app_state:2 win_state:0(0) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.491+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:1, app_state:2 win_state:0(0) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.531+0900 W/W_HOME  (  776): event_manager.c: _window_visibility_cb(453) > Window [0x2800003] is now visible(0)
10-24 19:26:08.531+0900 W/W_HOME  (  776): event_manager.c: _window_visibility_cb(463) > state: 0 -> 1
10-24 19:26:08.531+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:4, app_state:2 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.531+0900 W/W_HOME  (  776): main.c: _window_visibility_cb(1227) > Window [0x2800003] is now visible(0)
10-24 19:26:08.551+0900 I/APP_CORE(  776): appcore-efl.c: __do_app(429) > [APP 776] Event: RESUME State: PAUSED
10-24 19:26:08.551+0900 I/CAPI_APPFW_APPLICATION(  776): app_main.c: app_appcore_resume(223) > app_appcore_resume
10-24 19:26:08.556+0900 W/W_HOME  (  776): main.c: _appcore_resume_cb(685) > appcore resume
10-24 19:26:08.571+0900 W/W_HOME  (  776): event_manager.c: _app_resume_cb(366) > state: 2 -> 1
10-24 19:26:08.571+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:2, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.586+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:0, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.586+0900 W/W_HOME  (  776): event_manager.c: _state_control(194) > control:1, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-24 19:26:08.601+0900 W/APPS    (  776): apps_main.c: _time_changed(303) >  date : 24->24
10-24 19:26:08.621+0900 W/wnotib  (  776): w-notification-board-broker-main.c: _wnb_ecore_x_event_visibility_changed_cb(420) > fully_obscured: 0
10-24 19:26:08.916+0900 I/MALI    (  776): egl_platform_x11_tizen.c: tizen_update_native_surface_private(176) > [EGL-X11] surface->[0x442abba8] swap changed from async to sync
10-24 19:26:09.511+0900 E/EFL     (  776): ecore_x<776> ecore_x_events.c:563 _ecore_x_event_handle_button_press() ButtonEvent:press time=76607174 button=1
10-24 19:26:09.511+0900 E/W_HOME  (  776): move.c: _mouse_move_cb(546) > apps move is not allowed
10-24 19:26:09.511+0900 E/W_HOME  (  776): move.c: _mouse_down_cb(384) > apps move is not allowed
10-24 19:26:09.511+0900 W/APPS    (  776): AppsViewList.cpp: _scrollerMouseDown(889) >  Find item [0,290,216,136]
10-24 19:26:09.536+0900 E/W_HOME  (  776): move.c: _mouse_move_cb(546) > apps move is not allowed
10-24 19:26:09.551+0900 E/EFL     (  776): ecore_x<776> ecore_x_events.c:722 _ecore_x_event_handle_button_release() ButtonEvent:release time=76607213 button=1
10-24 19:26:09.551+0900 W/APPS    (  776): AppsItem.cpp: onItemClicked(444) >  onItemClicked[0,12]
10-24 19:26:09.551+0900 E/APPS    (  776): effect.c: apps_effect_play_sound(86) >  effect_info.sound_status: [0]
10-24 19:26:09.551+0900 W/APPS    (  776): AppsItem.cpp: onItemClicked(456) >  item(sensorbasicui) launched, open(0)
10-24 19:26:09.556+0900 W/AUL     (  776): launch.c: app_request_to_launchpad(268) > request cmd(0) to(org.example.sensorbasicui)
10-24 19:26:09.556+0900 W/AUL_AMD (  540): amd_request.c: __request_handler(645) > __request_handler: 0
10-24 19:26:09.561+0900 W/AUL_AMD (  540): amd_launch.c: _start_app(1713) > caller pid : 776
10-24 19:26:09.561+0900 I/AUL_AMD (  540): amd_launch.c: __check_app_control_privilege(1602) > Skip the privilege check in case of preloaded apps
10-24 19:26:09.576+0900 E/RESOURCED(  542): block.c: block_prelaunch_state(134) > insert data org.example.sensorbasicui, table num : 1
10-24 19:26:09.576+0900 E/RESOURCED(  542): heart-memory.c: heart_memory_get_data(601) > hashtable heart_memory_app_list is NULL
10-24 19:26:09.586+0900 W/AUL_AMD (  540): amd_launch.c: _start_app(2127) > pad pid(-5)
10-24 19:26:09.586+0900 W/AUL_PAD ( 1173): launchpad.c: __launchpad_main_loop(620) > Candidate is not prepared, enter legacy logic
10-24 19:26:09.586+0900 W/AUL_PAD ( 1173): launchpad.c: __send_result_to_caller(272) > Check app launching
...
10-24 19:26:17.416+0900 W/CRASH_MANAGER(10064): worker.c: worker_job(1205) > 061014973656e157191276
